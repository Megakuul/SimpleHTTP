...
bool performTestWithBody(CURL *curl, const string& url, string body, int bitShift, const string& expectedResponse) {
  ...
  // SimpleHTTP currently does not support Expect header, therefore it is set to ""
